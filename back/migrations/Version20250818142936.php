...
final class Version20250818170000_add_modification_history extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // comments (apostrophes doubled for SQL)
    ...
    {
        // drop indexes (IF EXISTS is ignored by DBAL, but we keep order)
